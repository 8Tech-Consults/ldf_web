            ...
            <div class="d-flex flex-column align-items-center w-lg-50 h-100 px-3 px-lg-5 pt-5">
                ...
                <div class="w-100 mt-auto" style="max-width: 526px;">
                    ...
                    <form action="{{ admin_url('auth/login') }}" method="post">
                        ...
                        <hr>
                        <p class="text-center mt-3"><a class="h2 text-primary text-center fs-5 fw-700 pt-2 pt-md-3" href="{{ $mobile_app }}"
                            target="_blank" rel="noopener"
                            >DOWNLOAD LDF
                                MOBILE APP 📱</a></p>
                    </form>
                </div>
                <p class="nav w-100 fs-sm pt-4 mt-auto mb-5 text-center"><span class="text-body-secondary">&copy;
                        {{ date('Y') }} All rights reserved. Made by</span> <a
                        class="nav-link d-inline-block p-0 ms-1 text-primary fw-bold" href="https://8technologies.net"
